...
export type ContactRole = 'agent' | 'client' | 'buyer' | 'seller' | 'lender' | 'title' | 'attorney' | 'inspector' | 'appraiser' | 'tc' | 'other' | 'staff' | 'online_database';
...
export type ActivityType =
  ...
  | 'document_requested' | 'document_confirmed' | 'reminder_set' | 'note' | 'price_change' | 'email_sent';
