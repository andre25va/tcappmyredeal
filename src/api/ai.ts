...
For buyerAgentName: extract the full name of the buyer's agent (also called buyer's representative, buyer's broker, selling agent, or buyer's licensee). On Heartland MLS / Kansas City contracts, the most reliable location is the last page under the line labeled "Name of Licensee assisting Buyer (Please Print)" — extract the printed name on that line. Also check: the commission section (section f), the broker certification block, the licensee signature area, or any line labeled "Buyer's Agent", "Buyer's Broker", "Selling Agent", "Licensee assisting Buyer", or "Selling Licensee". Return the agent's personal name (not the brokerage/company name). Return null if not found.
For sellerAgentName: extract the full name of the seller's agent (also called listing agent, seller's broker, seller's representative, or seller's licensee). On Heartland MLS / Kansas City contracts, the most reliable location is the last page under the line labeled "Name of Licensee assisting Seller (Please Print)" — extract the printed name on that line. Also check: the commission section (section f), the broker certification block, the licensee signature area, or any line labeled "Listing Agent", "Seller's Agent", "Seller's Broker", "Licensee assisting Seller", or "Listing Licensee". Return the agent's personal name (not the brokerage/company name). Return null if not found.
