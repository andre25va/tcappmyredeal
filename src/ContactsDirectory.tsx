          ...
          <div className="modal-box max-w-2xl max-h-[90vh] flex flex-col p-0">
            ...
            <div className="overflow-y-auto flex-1 px-5 py-4 space-y-5">
              ...
              <div>
                ...
                <div className="mt-2">
                  <label className="label py-0"><span className="label-text text-xs">Company / Brokerage</span></label>
                ...
                {form.isClient && (
                  <div className="mt-2">
                    <label className="label py-0">
                      <span className="label-text text-xs font-medium text-amber-700">Team Name</span>
                      <span className="label-text-alt text-xs text-base-content/50">used in TC signatures &amp; emails</span>
                    </label>
                    <input
                      className="input input-sm input-bordered w-full border-amber-300 focus:border-amber-500"
