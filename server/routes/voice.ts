...
async function handleAdminInbound(req: Request, res: Response, phone: string) {
...
async function handleAdminQuery(req: Request, res: Response) {
...
async function handleAdminWrapup(req: Request, res: Response, phone?: string, callSid?: string) {
...
async function handleAdminEmailConfirm(req: Request, res: Response) {
...
async function handleClientAIInbound(req: Request, res: Response, caller: CallerContext) {
  const { CallSid } = req.body;
...
async function handleClientDealSelect(req: Request, res: Response) {
...
async function handleClientAIQuery(req: Request, res: Response) {
  const { SpeechResult, From, CallSid } = req.body;
  const phone = (req.query.phone as string) || normalizeToE164(From || '');
  const callSid = (req.query.callSid as string) || CallSid || '';
...
async function handleClientAIWrapup(req: Request, res: Response, phone?: string, callSid?: string, dealId?: string) {
  const _phone = phone || (req.query.phone as string) || '';
  const _callSid = callSid || (req.query.callSid as string) || '';
...
async function handleClientDealEmailConfirm(req: Request, res: Response) {
  const { SpeechResult, Digits } = req.body;
  const phone = (req.query.phone as string) || '';
  const callSid = (req.query.callSid as string) || '';
  const dealId = (req.query.dealId as string) || '';
...
async function handleIntent(req: Request, res: Response) {
...
async function handleDealSelect(req: Request, res: Response) {
  const { Digits, From } = req.body;
  const phone = (req.query.phone as string) || normalizeToE164(From || '');
...
async function handleStatusTextDirect(res: Response, deal: any, phone: string) {
...
async function handleStatusText(req: Request, res: Response) {
  const dealId = req.query.dealId as string;
...
async function handleCallbackReason(req: Request, res: Response) {
  const phone = (req.query.phone as string) || normalizeToE164(req.body.From || '');
...
async function handleCallbackConfirm(req: Request, res: Response) {
...
async function handleOutboundConnect(req: Request, res: Response) {
...
async function handleOutboundDialStatus(req: Request, res: Response) {
...
async function handleOutboundParentStatus(req: Request, res: Response) {
...
voiceRouter.post('/:route', async (req: Request, res: Response) => {
  if (req.method !== 'POST') {
