...
For sellerNames: MECHANICAL EXTRACTION ONLY — do not reason, just locate and copy the party name.
  ...
  RULE: This is the SELLER party (person or company who owns the property). Do NOT confuse with the listing agent/licensee. Return null if not found.
For buyerNames: MECHANICAL EXTRACTION ONLY — do not reason, just locate and copy the party name.
  ...
  RULE: This is the BUYER party (person purchasing the property). Do NOT confuse with the buyer's agent/licensee. Return null if not found.
