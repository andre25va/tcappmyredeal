...
For saleContingency (line 286-292): Look at lines 288 and 290. Line 288 = "This Contract is NOT contingent upon the sale and/or Closing of a BUYER'S Property". Line 290 = "This Contract IS contingent upon the sale and/or Closing of a BUYER'S Property". The one with ☑ is checked. Return "IS Contingent" if L290 is checked. Return "NOT Contingent" if L288 is checked. Return "unknown" if neither is visible.
For saleType (lines 296-299): Line 296 = "THIS IS A CASH SALE", Line 299 = "THIS IS A FINANCED SALE". Exactly one will have ☑. Return "Cash" if L296 is checked, "Financed" if L299 is checked. Return "" if not determinable.
...
For earnestMoneyRefundable: Find line 181 (or the line labeled "(Check one) refundable / non-refundable" in the Earnest Money section). There are exactly TWO checkboxes on this line: the FIRST checkbox is next to the word "refundable" and the SECOND checkbox is next to "non-refundable". Look carefully at which checkbox has a mark (☑, ✓, X, or filled square). IMPORTANT: The "refundable" checkbox comes FIRST (left side). If the FIRST/LEFT checkbox is marked → return the STRING "Refundable". If the SECOND/RIGHT checkbox is marked → return the STRING "Non-refundable". Do NOT confuse "refundable" with "non-refundable" — they are separate checkboxes. Return empty string "" only if this line is completely absent. NEVER return null.
