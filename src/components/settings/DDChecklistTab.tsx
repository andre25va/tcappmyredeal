...
import { Plus, Pencil, Trash2, X, Check, GripVertical, MoreVertical, Star, AlertCircle } from 'lucide-react';
    ...
    <div className="max-w-3xl mx-auto flex flex-col gap-5">
      <div>
        ...
        <div className="mt-2 flex items-start gap-2 bg-blue-50 border border-blue-200 rounded-lg px-3 py-2">
          ...
          <p className="text-xs text-blue-700"><strong>Due Diligence</strong> asks <em>"What needs to get done?"</em></p>
        </div>
      </div>
