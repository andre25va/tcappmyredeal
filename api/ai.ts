...
For buyerAgentName: find the exact label text "Name of Licensee assisting Buyer (Please Print)" anywhere in the document. The buyer agent's name is the handwritten or printed text that appears on the blank line IMMEDIATELY BEFORE (above) that label in the document's reading order. Do NOT use the line labeled "BUYER" — that is the buyer client's name, not the agent. Do NOT use the BROKERAGE line. The buyer agent is a real estate licensee/agent/REALTOR, not the buyer party. Buyer names often appear early in the contract under "BUYER:" — those are clients, not agents. Return the agent's personal name only (not the brokerage/company name). Return null if the label is not found or the line above it is blank.
For sellerAgentName: find the exact label text "Name of Licensee assisting Seller (Please Print)" anywhere in the document. The seller agent's name is the handwritten or printed text that appears on the blank line IMMEDIATELY BEFORE (above) that label in the document's reading order. Do NOT use the line labeled "SELLER" — that is the seller client's name, not the agent. Do NOT use the BROKERAGE line. Do NOT use the buyer's name. The seller agent is a real estate licensee/agent/REALTOR, not the seller or buyer party. If the line above the label is blank or not clearly a person's name in a licensee context, return null. Return null if the label is not found or if you are not confident this is a real estate professional's name (not a buyer/seller client). Return the agent's personal name only (not the brokerage/company name).
