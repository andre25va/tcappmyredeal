...
// Map full state names / abbreviations to synonyms for search expansion (all 50 states + DC)
const STATE_SYNONYMS: Record<string, string[]> = {
  ...
  'district of columbia': ['dc', 'district of columbia'], 'dc': ['dc', 'district of columbia'],
  ...
  'new hampshire': ['nh', 'new hampshire'], 'nh': ['nh', 'new hampshire'],
  'new jersey': ['nj', 'new jersey'], 'nj': ['nj', 'new jersey'],
  'new mexico': ['nm', 'new mexico'], 'nm': ['nm', 'new mexico'],
  'new york': ['ny', 'new york'], 'ny': ['ny', 'new york'],
  'north carolina': ['nc', 'north carolina'], 'nc': ['nc', 'north carolina'],
  'north dakota': ['nd', 'north dakota'], 'nd': ['nd', 'north dakota'],
  ...
  'rhode island': ['ri', 'rhode island'], 'ri': ['ri', 'rhode island'],
  'south carolina': ['sc', 'south carolina'], 'sc': ['sc', 'south carolina'],
  'south dakota': ['sd', 'south dakota'], 'sd': ['sd', 'south dakota'],
  ...
  'west virginia': ['wv', 'west virginia'], 'wv': ['wv', 'west virginia'],
