...
const MERGE_TAGS = [
  ...
  { tag: '{{inspectionDeadline}}', desc: 'Inspection deadline (contract date + inspection period days)' },
  { tag: '{{inspectionPeriodDays}}', desc: 'Number of inspection period business days' },
  { tag: '{{emDate}}', desc: 'Earnest money deadline date' },
  { tag: '{{possessionDate}}', desc: 'Possession date' },
  { tag: '{{inspectionDate}}', desc: 'Inspection date' },
  { tag: '{{loanDate}}', desc: 'Loan commitment date' },
  { tag: '{{titleDate}}', desc: 'Title commitment date' },
  ...
  { tag: '{{tcTeamSignature}}', desc: 'TC Team closing signature — "TC Team for [Agent]" or "Transaction Coordinating Team for [Team Name]"' },
  // Contact Blocks
  { tag: '{{buyersSide}}', desc: 'Auto-populated buyers side block (buyers, buyer agent, attorney)' },
  { tag: '{{sellersSide}}', desc: 'Auto-populated sellers side block (sellers, seller agent, attorney)' },
  { tag: '{{agents}}', desc: 'Auto-populated agent info block' },
  { tag: '{{contacts}}', desc: 'Auto-populated full contact list' },
